...
class MonthlyTaskContainer extends StatefulWidget {
  final MainGoal mainGoal;
  final Task task;

  const MonthlyTaskContainer(
      {Key? key, required this.mainGoal, required this.task})
      : super(key: key);

  @override
  State<MonthlyTaskContainer> createState() => _MonthlyTaskContainerState();
}

class _MonthlyTaskContainerState extends State<MonthlyTaskContainer> {
